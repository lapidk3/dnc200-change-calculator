/**
 * File name: Quarter.cs
 * Author: Kenneth Lapid David
 *
 * This file contains the Quarter class, which defines Quarter objects
 */
 ...
 {
     public class Quarter : IMoney
     {
         public int value; // The value that quarter will hold
         public int count; // How much of this money do you have

        /**
         * This constructor will construct a Quarter object and set it's value to be 25
         *
         */
         public Quarter() {
             this.value = 25;
        ...
        public void Print() {
            if(this.count == 1) {
                ...
                Console.WriteLine(this.count + " Quarters");
            }
        }
